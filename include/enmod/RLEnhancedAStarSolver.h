#ifndef ENMOD_RL_ENHANCED_ASTAR_SOLVER_H
#define ENMOD_RL_ENHANCED_ASTAR_SOLVER_H
...
class RLEnhancedAStarSolver : public Solver {
public:
    RLEnhancedAStarSolver(const Grid& grid_ref);
    void run() override;
...
#endif // ENMOD_RL_ENHANCED_ASTAR_SOLVER_H